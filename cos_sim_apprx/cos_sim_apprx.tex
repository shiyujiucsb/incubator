...
We also evaluate our algorithms by experiments to verify that our upper bounds are tight enough for practical use.
\end{abstract}
...
Figure \ref{fig:cnae} and Figure \ref{fig:cuae} present the approximation errors and upper bound given by Algorithm \ref{alg:csa}.
...
Figure \ref{fig:rgae} and Figure \ref{fig:swae} present the approximation errors and upper bound given by Algorithm \ref{alg:sra}.
