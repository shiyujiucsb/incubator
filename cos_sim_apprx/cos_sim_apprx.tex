...
\begin{algorithm}[!t]
\caption{\emph{Random Walk Generation}}
\label{alg:rwg}
...
\begin{theorem}
\label{thm:new}
Let $F$ be a collection of functions $f$ mapping $D$ to $[0,1]$. 
With probability at least $1-\delta$, we have
